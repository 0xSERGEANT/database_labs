...
**Результати:**
- Файл схеми Prisma ([schema.prisma](prisma/schema.prisma))
- Директорія міграцій ([migrations/](prisma/migrations/))
- Звіт Markdown ([migration-notes.md](docs/migration-notes.md))
- Скрипт перевірки працездатності схеми ([script.ts](src/index.ts))
